...
describe('PDF to PNG Page', () => {
  checkGeneralTool(toolName)
  globalTools(toolName, false, true, false, 'How To Convert PDF to PNG')
  ...
  describe('Download Page Unit Test', () => {
    singleDownload(toolName, 'pdf_main.png')
